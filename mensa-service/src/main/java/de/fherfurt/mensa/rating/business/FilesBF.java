...
import static de.fherfurt.mensa.rating.entity.FileSystemRepository.FileTypes;
...
public class FilesBF {
    ...
    /**
     * Saves a given file (content) under the specific subdirectory ({@link FileTypes#name()}
     * for the given name (fileName).
     *
     ...
     */
    public void save(FileTypes type, String fileName, byte[] content, boolean replace) throws IOException {
        if (!replace) {
